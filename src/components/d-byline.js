...
export function bylineTemplate(frontMatter) {
  ...
  <div class="byline grid">
    ...
    <div>
      ...
      <p>
        HI
        ${frontMatter.arxivUrl ? `<a href="${frontMatter.arxivUrl}">arXiv</a>` : ''}
        ${(frontMatter.arxivUrl && frontMatter.codeUrl) ? ' | ' : ''}
        ${frontMatter.codeUrl ? `<a href="${frontMatter.codeUrl}">Code</a>` : ''}
      </p>
    </div>
  </div>
`;
...
export class Byline extends HTMLElement {
  ...
  set frontMatter(frontMatter) {
    console.log('Byline frontMatter:', frontMatter);
